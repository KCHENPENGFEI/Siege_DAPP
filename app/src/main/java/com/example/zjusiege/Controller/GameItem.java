...
public class GameItem {
    ...
    public final  String CONTRACT_ADDRESS = "0x930ef6b50e0537a9c06525022d861a073db60caf";
    ...
    public String game_item() throws Exception{
        ...
        String abi = Utils.readFile("contract/build/OutfitPiece.abi");
        String bin = Utils.readFile("contract/build/OutfitPiece.bin");
...
//        log("合约更新： " + contractUpdateResult.getRet());
        ...
        FuncParamReal id = new FuncParamReal("uint256", 1);
        String paylaod1 = FunctionEncode.encodeFunction("balanceOf", owner, id);
        Transaction transaction1 = new Transaction(account2.getAddress(), CONTRACT_ADDRESS, paylaod1, false);
        transaction1.signWithSM2(ACCOUNT2, "");
        ...
        // 创建皮肤碎片1
//        FuncParamReal supply = new FuncParamReal("uint256", 100);
//        FuncParamReal uri = new FuncParamReal("string", "outfitPiece_1");
//        String payload = FunctionEncode.encodeFunction("create", supply, uri);
...
//        log("调用create: " + decodeResult);
        ...
        // 发行皮肤碎片给玩家1和2，10个和15个
//        FuncParamReal id = new FuncParamReal("uint256", 1);
//        FuncParamReal to = new FuncParamReal("address[]", new String[]{account1.getAddress(), account2.getAddress()});
//        FuncParamReal values = new FuncParamReal("uint256[]", new int[]{10, 15});
//        String payload = FunctionEncode.encodeFunction("issue", id, to, values);
//        Transaction transaction = new Transaction(deployAccount.getAddress(), CONTRACT_ADDRESS, payload, false);
//        transaction.signWithSM2(DEPLOY_ACCOUNT_JSON, "");
//
//        ReceiptReturn receiptReturn = hyperchain.invokeContract(transaction);
//        String rawReturn = receiptReturn.getRet();
//        String decodeResult = FunctionDecode.resultDecode("issue", abi, rawReturn);
//        log("调用issue: " + decodeResult);

        // 开发商增加皮肤碎片1
//        FuncParamReal id = new FuncParamReal("uint256", 1);
//        FuncParamReal value = new FuncParamReal("uint256", 50);
//        String payload = FunctionEncode.encodeFunction("increase", id ,value);
//        Transaction transaction = new Transaction(deployAccount.getAddress(), CONTRACT_ADDRESS, payload, false);
//        transaction.signWithSM2(DEPLOY_ACCOUNT_JSON, "");
//
//        ReceiptReturn receiptReturn = hyperchain.invokeContract(transaction);
        // 玩家2销毁了10个皮肤碎片1
//        FuncParamReal id = new FuncParamReal("uint256[]", new int[]{1});
//        FuncParamReal value = new FuncParamReal("uint256[]", new int[]{10});
//        String payload = FunctionEncode.encodeFunction("burn", id, value);
//        Transaction transaction = new Transaction(account2.getAddress(), CONTRACT_ADDRESS, payload, false);
//        transaction.signWithSM2(ACCOUNT2, "");
//
//        ReceiptReturn receiptReturn = hyperchain.invokeContract(transaction);
