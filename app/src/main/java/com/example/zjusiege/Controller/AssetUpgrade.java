...
//    public final String CONTRACT_ADDRESS = "0x429f382e15054439b0bc4fc1139e729d4dc5e578";
     ...
     */
    @RequestMapping("/AssetUpgrade")
    public String AssetUpgrade() throws Exception {
        ...
        Transaction transaction = new Transaction(deployAccount.getAddress(), assetAddress, bin, 1, VMType.EVM);
