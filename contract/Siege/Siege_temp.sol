...
// contract SiegeAsset {
// 	function transfer(address _from, address _to, uint256 _value, string memory _symbol, bytes memory _data) external;
// 	function transferNFTs(address _from, address _to, uint256[] memory _uuids, bytes memory _data) external;
// 	function balanceOf(address _owner, string memory _symbol) external;
// 	function supplyOf(string memory _symbol, uint8 _ext) external;
...
contract Siege {
    ...
    */
	function settlement(uint256 gameId, address[] playerAddresses) view external onlyRoot() {
		// 确保游戏状态正确
